...
class CoreUtilRespondent(TestCase):
    ...
    def test_get_chartjs_dict(self):
        ...
        self.assertEqual(chart_dict.keys(), {'data', 'lineTension', 'backgroundColor', 'borderColor', 'borderWidth',
    ...
    def test_get_progress_graphs(self):
        ...
        self.assertEqual(overall_graph['scores'][0].keys(),
                         {'data', 'lineTension', 'backgroundColor', 'borderColor', 'borderWidth',
                          'pointBackgroundColor'})
        ...
        self.assertEqual(group_graph['scores'][0].keys(),
                         {'data', 'lineTension', 'backgroundColor', 'borderColor', 'borderWidth',
                          'pointBackgroundColor'})
