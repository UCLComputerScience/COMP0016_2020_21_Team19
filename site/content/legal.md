...
The application "Activity League" and its source code is licensed under the [GNU Affero General Public License v3.0](https://www.gnu.org/licenses/agpl-3.0.en.html).
...
| [python3-openid](http://github.com/necaris/python3-openid)                           | 3.2.0     | Apache 2.0                         | OpenID support for modern servers and consumers.                                                                                                        |
| [python-dateutil](https://dateutil.readthedocs.io)                                   | 2.8.1     | Apache 2.0                         | Extensions to the standard Python datetime module                                                                                                       |
...
| [django-import-export](https://github.com/django-import-export/django-import-export) | 2.5.0     | BSD                                | Django application and library for importing and exporting data with included admin integration.                                                        |
| [cryptography](https://github.com/pyca/cryptography)                                 | 3.4.6     | BSD or Apache 2.0                  | A package which provides cryptographic recipes and primitives to Python developers.                                                                     |
...
| [django-invitations](https://github.com/bee-keeper/django-invitations.git)           | 1.9.3     | GPLv3                              | Generic invitations app with support for django-allauth                                                                                                 |
| [odfpy](https://github.com/eea/odfpy)                                                | 1.4.1     | GPL                                | Python API and tools to manipulate OpenDocument files                                                                                                   |
...
| [Bootstrap](https://getbootstrap.com/)                                               | 5.0.0     | MIT                                | A free and open-source CSS framework directed at responsive, mobile-first front-end web development.                                                    |
| [Chart.js](https://www.chartjs.org/)                                                 | 2.7.1     | MIT                                | A free and open-source JavaScript library for data visualization.                                                                                       |
| [Popper.js](https://popper.js.org/ )                                                 | 1.16.1    | MIT                                | A free and open-source JavaScript positioning engine.                                                                                                   |
| [Feather Icons](https://feathericons.com/)                                           | 4.28.0    | MIT                                | A collection of simply beautiful open source icons.                                                                                                     |
| [jQuery](https://jquery.com/)                                                        | 3.5.1     | MIT                                | A JavaScript library designed to simplify HTML DOM tree traversal and manipulation, as well as event handling, CSS animation, and Ajax.                 |
...
| [pyparsing](https://github.com/pyparsing/pyparsing/)                                 | 2.4.7     | MIT                                | Python parsing module                                                                                                                                   |
| [django-allauth](http://github.com/pennersr/django-allauth)                          | 0.44.0    | MIT                                | Integrated set of Django applications addressing authentication, registration, account management as well as 3rd party (social) account authentication. |
...
| [defusedxml](https://github.com/tiran/defusedxml)                                    | 0.7.1     | PSF                                | XML bomb protection for Python stdlib modules                                                                                                           |
...
Supervisors and Teaching Assistants: [Dr Graham Roberts](http://www.cs.ucl.ac.uk/staff/g.roberts) and Binghao Chai
