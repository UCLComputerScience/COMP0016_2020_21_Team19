<template>
    ...
    <div style="height: 9vh; background: #7e57c2"></div>
        ...
        <div class="alert" v-if="showWarning">
            ...
            <strong>That didn't work, to make sure the documentation is displaying correctly, please try right click the link and open the external link in a new tab.</strong>
        </div>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        mounted(){
            let style = document.getElementById("guideStyle");
            style.href = "css/guide.css";
        },
        beforeDestroy(){
            let style = document.getElementById("guideStyle");
            style.href = "";
